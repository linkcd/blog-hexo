...
seed1="seed:YMWCOSQBLSRYNVAIJEEEEXZKNG9HWOV9BLQIARPEUTOHTDRK"
r1=$(curl -X POST "${webapi%?}"  -H "accept: application/json" -H "${seed1%?}" -H "Content-Type: application/json" -d '{ "dataPackageId": "police#123", "ownerMetadata":"Norwegian police station", "wayOfProof": "copy of original text", "valueOfProof": "2018 20. februar 13:00: En liten bilulykke utenfor Esso bensinstasjon på Billingstadsletta 9, 1396 Billingstad. Bilskade: 5000 NOK."}')
#echo "$r1"
address1=$(jq '.mamAddress' <<< "$r1")
echo "police station data integrity address:" $address1
###############################################################
# Translator
seed2="seed:YMWCOSQBLSRYNVAIJXS9UTMQEZMXZKNG9HWOV9BLQIARPEUTOHTDRK"
...
seed3="seed:YMWCOSQBLSRYNVAIJEEEEVGEWOV9BLQIARPEUTOHTDRK"
...
###############################################################
# Map provider
seed4="seed:YMWCOSQBLSRYNVAIJEEEEVGMFCS9UXNG9HWOV9BLQIARTDRK"
...
###############################################################
#Custmoer report
seed5="seed:YMWCOSQBLSRYNVAIJXS9UTMQEDEREZMXZKNG9HWOV9BLQIARPEUTOHTDRK"
